...
export const BuiltInPromptParams = [
  ...
  { key: "current_task_prompt", label: "Current Task Prompt", description: "Generated task-scoped prompt used by Adaptive Auto Workflow task loops.", sample: "# Adaptive Task Prompt: TASK-001" },
  { key: "current_task_failure_feedback", label: "Current Task Failure Feedback", description: "Retry feedback filtered to the active TASK-xxx instead of the full run feedback.", sample: "Retry feedback for TASK-001 only." },
  { key: "latest_failure_feedback", label: "Latest Failure Feedback", description: "Only the newest retry feedback block for the current step, capped to avoid very large prompts.", sample: "Latest retry error only." },
  ...
  { key: "build_result", label: "Build Result", description: "Rendered content from output/build-result.md.", sample: "Status: READY\nChanged files:\n- app/main.py" },
