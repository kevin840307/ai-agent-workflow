import {
  ...
  StepTypes,
  TemplatePresets,
} from "../workflow-designer-constants.js?v=20260703-agent-stream1";
import {
  clone,
  copyTextToClipboard,
  el,
  ...
  setText,
  toast,
} from "./utils.js?v=20260703-agent-stream1";
import {
  createStep,
  createWorkflow,
  defaultFilename,
  ...
  normalizeStep,
  normalizeWorkflow,
} from "./model.js?v=20260703-agent-stream1";
import {
...
} from "./function-catalog.js?v=20260703-agent-stream1";
import { installLayoutRenderer } from "./layout-renderer.js?v=20260703-agent-stream1";
import { installStepSettingsRenderer } from "./step-settings-renderer.js?v=20260703-agent-stream1";
import { installTemplateEditor } from "./template-editor.js?v=20260703-agent-stream1";
import { installImportExportTools } from "./import-export.js?v=20260703-agent-stream1";
import { installWorkflowAssetTools } from "./asset-tools.js?v=20260703-agent-stream1";
...
const DesignerActionHandlers = Object.freeze({
  ...
  "save-metadata-asset": () => assetTools.saveMetadataAssetForSelectedStep(),
  "edit-python-asset": () => assetTools.editPythonAssetForSelectedStep(),
