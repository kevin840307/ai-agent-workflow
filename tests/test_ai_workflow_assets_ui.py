...
class AiWorkflowAssetsUiTests(unittest.TestCase):
    ...
    def test_workflow_designer_shows_copyable_cli_commands_without_ok_lint_copy(self) -> None:
        ...
        self.assertIn('python -m app.cli.aiwf . --engine auto --user "需求"', html)
        self.assertIn('/wf --engine qwen --user "需求"', html)
        self.assertIn('/wf --engine opencode --user "需求"', html)
        ...
        self.assertIn("python -m app.cli.aiwf . --engine auto", layout)
        self.assertIn("/wf --engine qwen", layout)
        self.assertIn("/wf --engine opencode", layout)
