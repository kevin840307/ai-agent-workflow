...
class AiWorkflowAssetsUiTests(unittest.TestCase):
    ...
    def test_workflow_designer_shows_copyable_cli_commands_without_ok_lint_copy(self) -> None:
        ...
        self.assertIn('python -m app.cli.aiwf . --engine auto --workflow workflow-id --user "需求"', html)
        self.assertIn('/wf --workflow workflow-id --user "需求"', html)
        ...
        self.assertIn("python -m app.cli.aiwf . --engine auto --workflow", layout)
        self.assertIn("/wf --workflow", layout)
