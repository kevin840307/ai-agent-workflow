...
- Use Qwen/OpenCode file edit/write tools to modify files directly. Do not return platform file blocks, explanations, placeholders, simulated workflow code, or repair helper functions.
