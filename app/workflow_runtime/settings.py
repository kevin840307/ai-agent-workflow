...
from app.core.paths import ROOT, SETTINGS_FILE, ensure_dirs, write_text
...
def _apply_defaults(settings: dict[str, Any]) -> dict[str, Any]:
    ...
    settings["agents"]["providers"]["opencode"].setdefault("reuseSession", bool(settings["qwen"].get("reuse_session", False)))
