...
- You may edit/write only files inside this project root: `C:\Users\kevin\testllm\reports\stability-v20\qwen-repaired-cells\qwen-adaptive-auto-workflow-code-with-validation\fixture\code-with-validation-project`.
