...
- Qwen/OpenCode direct edits are verified through the platform project-diff guard.
...
- Build directly modified production files through Qwen/OpenCode edit/write tools, and the platform accepted the project diff.
